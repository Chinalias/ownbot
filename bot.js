                  ...
                  ctx.drawImage(ground, 0, 0, 557, 241);
                      ...
                      jimp.read(url, (err, ava) => {
                          ...
                          ava.getBuffer(jimp.MIME_PNG, (err, buf) => {
                              ...
                              ctx.fontSize = '28px';
                              ctx.fillStyle = "#FFFFFF";
      ctx.fillText(`Welcome To ${member.guild.name}`, 240, 60);
...
//=====================================================SetWlc
      ...
      const devs = ['331081268731052042','421023400971075585'];
const adminprefix = "$"
